...
def get_parser():
    ...
    parser.add_argument("--tokens", type=str, default=str(MODEL_DIR / "tokens.txt"))
    parser.add_argument("--encoder", type=str, default=str(MODEL_DIR / "encoder.onnx"))
    parser.add_argument("--decoder", type=str, default=str(MODEL_DIR / "decoder.onnx"))
    parser.add_argument("--joiner", type=str, default=str(MODEL_DIR / "joiner.onnx"))
    ...
    parser.add_argument("--text-format", type=str, default="none")  # none/lower/capitalize
    return parser
